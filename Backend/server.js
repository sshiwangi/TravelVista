...
app.use((error, req, res, next) => {
  ...
  res.status(validStatusCode ? statusCode : 500);
...
mongoose
  .connect(
    `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASSWORD}@cluster0.lvcn5c7.mongodb.net/${process.env.DB_NAME}?retryWrites=true&w=majority`
  )
  .then(() => {
